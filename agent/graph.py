...
WRITER_PROMPT = (
    ...
    "figures (write 'the deadline has passed', not a date or a count). "
    "The disposition field must echo the ladder's level exactly. If a "
    "submission is rejected, follow the correction in the error text "
    "exactly and resubmit. After every interrupt-now "
...
DRAFTER_PROMPT = (
    ...
    "digits of any kind (name the fact, never a figure); pass an "
